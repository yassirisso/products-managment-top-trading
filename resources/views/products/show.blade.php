                            ...
                            @forelse($product->suppliers as $supplier)
                                ...
                                <tr class="border-t">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        @if($supplier->pivot->payment_status == 'paid')

                                            <span class="px-2 py-1 text-xs rounded bg-green-100 text-green-700">
                                                Paid
                                            </span>

                                        @elseif($supplier->pivot->payment_status == 'partial')
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        @if($supplier->pivot->date_first_payment)

                                            First:
                                            {{ $supplier->pivot->date_first_payment }}
                                        ...
                                        @if($supplier->pivot->date_rest_payment)

                                            Rest:
                                            {{ $supplier->pivot->date_rest_payment }}

                                        @endif


                                        @if(!$supplier->pivot->date_first_payment && !$supplier->pivot->date_rest_payment)
