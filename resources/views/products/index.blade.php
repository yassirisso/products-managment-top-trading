        ...
        <div class="flex flex-wrap justify-between items-center mb-6 gap-2">
            ...
            <div class="flex flex-wrap gap-2 items-center">
                ...
                <form action="{{ route('products.index') }}"
                    ...
                    <button type="submit"
                            class="bg-blue-500 hover:bg-blue-600 text-white px-4 rounded-r-md">
                ...
                <form action="{{ route('products.import') }}"
                    ...
                    <label class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg flex items-center cursor-pointer">
